...
export const AccessibilityModal: React.FC = () => {
  ...
  const handleApplyPreset = (preset: 'standard' | 'highContrast' | 'easyMode' | 'voiceAssist') => {
    switch (preset) {
      ...
      case 'easyMode':
        ...
        speak('Easy Mode activated with single-task simplified screens.');
        break;
      case 'voiceAssist':
        updateAccessibility({
          voiceGuidance: true,
  ...
  return (
    <div 
      ...
      className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-stone-950/70 backdrop-blur-xs overflow-y-auto font-sans"
      role="dialog"
      aria-modal="true"
    ...
    >
      <div 
        ...
        className={`relative w-full max-w-2xl max-h-[92vh] overflow-y-auto rounded-2xl p-6 sm:p-8 shadow-2xl transition-all ${
      ...
      >
        ...
        <div className="flex items-start justify-between gap-4 pb-5 border-b border-stone-200">
          <div className="flex items-center gap-3">
            <div className={`p-2.5 rounded-xl ${
              accessibility.highContrast ? 'bg-yellow-400 text-black font-bold' : 'bg-stone-900 text-white'
            }`}>
            ...
            <div>
              ...
              <p className="text-xs text-stone-500 font-medium mt-0.5">
                {t.accessibilityOptionsSub || 'Tailor your reading, voice guidance, and navigation preferences.'}
              </p>
            </div>
          </div>
        ...
        <div className="mt-6">
          <label className="text-[11px] font-bold uppercase tracking-wider text-stone-500 block mb-3">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5">
            <button
              ...
              className={`p-3 rounded-xl border text-center transition flex flex-col items-center justify-center gap-1.5 ${
                !accessibility.highContrast && !accessibility.simplifiedMode && !accessibility.largeText
                  ...
                  : 'bg-stone-50 hover:bg-stone-100 text-stone-800 border-stone-200 font-medium'
              }`}
            >
            ...
            <button
              ...
              className={`p-3 rounded-xl border text-center transition flex flex-col items-center justify-center gap-1.5 ${
                accessibility.highContrast
                  ? 'bg-yellow-400 text-black border-yellow-300 shadow-xs font-bold'
                  : 'bg-stone-50 hover:bg-stone-100 text-stone-800 border-stone-200 font-medium'
              }`}
            >
            ...
            >
              ...
              <span className="text-xs">Easy Mode</span>
            </button>

            <button
              onClick={() => handleApplyPreset('voiceAssist')}
              className={`p-3 rounded-xl border text-center transition flex flex-col items-center justify-center gap-1.5 ${
                accessibility.voiceGuidance && !accessibility.simplifiedMode
                  ? 'bg-stone-900 text-white border-stone-900 shadow-xs font-bold'
                  : 'bg-stone-50 hover:bg-stone-100 text-stone-800 border-stone-200 font-medium'
              }`}
            >
              <Volume2 className="w-4 h-4 text-emerald-600" />
              <span className="text-xs">Voice Assist</span>
            </button>
          </div>
        </div>
        ...
        <div className="mt-6 space-y-3">
          ...
          <div className="p-4 rounded-xl border border-stone-200 bg-stone-50/60 flex items-center justify-between gap-4">
            <div className="flex items-center gap-3">
          ...
          <div className="p-4 rounded-xl border border-stone-200 bg-stone-50/60 flex items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              <div className="p-2 rounded-lg bg-purple-100 text-purple-900 shrink-0">
          ...
          <div className="p-4 rounded-xl border border-stone-200 bg-white">
            <div className="flex items-center justify-between gap-3 mb-2">
              <label htmlFor="speech-rate-slider" className="font-bold text-xs flex items-center gap-2 text-stone-800">
              ...
              <button
                ...
                className="px-3 py-1.5 rounded-lg bg-stone-900 hover:bg-stone-800 text-white text-xs font-bold transition shadow-xs flex items-center gap-1.5"
              >
        ...
        <div className="mt-6 pt-4 border-t border-stone-200 flex items-center justify-between gap-3">
          <button
            ...
            className="px-4 py-2 rounded-xl border border-stone-300 text-stone-700 hover:bg-stone-100 font-bold text-xs transition flex items-center gap-1.5"
          >
          ...
          <button
            ...
            onClick={() => setIsAccessibilityModalOpen(false)}
            className="px-6 py-2 rounded-xl bg-stone-900 hover:bg-stone-800 text-white font-bold text-xs transition shadow-xs"
          >
